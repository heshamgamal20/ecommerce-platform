...
final class InvoiceController extends Controller
{
    ...
    public function print(InvoiceRequest $request, int $orderId, ManageInvoices $invoices): Response { return response()->view('invoices.print', ['invoice'=>$invoices->show($orderId)]); }
